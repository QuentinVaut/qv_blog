...
if (isset($connect) && $connect == 1) {
    if (isset($_POST['envoyer']) || isset($_POST['modifier'])) {
        ...
        $row_id = (isset($_POST['envoyer'])) ? addArticle($titre, $texte, $date, $publie) : updateArticle($titre, $texte, $publie, $_POST['id']);
        ...
        $article = (isset($_GET['id'])) ? articleById($_GET['id']) : ""; //On appelle la fonction si un id existe
